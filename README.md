...
### SOC & Detection
- **[Wazuh SIEM](SIEM/Wazuh/)** — alert triage, custom rules, FIM and security-event analysis.
- **[Windows + Sysmon](Endpoint-Security/Windows-Sysmon-Detection-Lab/)** — endpoint telemetry and detection validation.
- **[Attack Simulation & Detection Engineering](Offensive-Security/Attack-Simulation-Detection-Lab/)** — controlled simulations, detections and ATT&CK mapping.
...
- **[Endpoint Security](Endpoint-Security/)** — Windows/Sysmon security telemetry and hardening.
...
These are **Forage virtual job simulations**, not employment with the named organizations.

### Mastercard — Cybersecurity Job Simulation
Completed September 20, 2026. Work included phishing-simulation design, interpretation of supplied campaign results and security-awareness training material.

**[Mastercard simulation repository](https://github.com/hnmasiya/mastercard-cybersecurity-job-simulation)**

### Datacom — Cyber Security Operations Job Simulation
Completed September 20, 2026. Work included simulated cyberattack investigation, risk assessment, threat research and security recommendations.

**[Datacom simulation repository](https://github.com/hnmasiya/Datacom-Cyber-Security-Operations-Job-Simulation)**
