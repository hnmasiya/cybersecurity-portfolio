...
| Attack Simulation & Detection Engineering Lab | Designed, awaiting execution | 3 MITRE ATT&CK techniques (T1059 Execution, T1053/T1547 Persistence, T1003 Credential Access) × 2 real, self-owned platforms (home-lab Linux host, Azure DC) — real simulation scripts and real custom Wazuh detection rules written, ready to run; no alert evidence captured yet |
