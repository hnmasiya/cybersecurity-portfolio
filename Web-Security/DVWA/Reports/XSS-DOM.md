# XSS DOM — DVWA Security Assessment

## Objective

Assess the DVWA XSS DOM vulnerability class in a controlled local laboratory environment and document the security implications, detection considerations and remediation strategy.
...
Test client-side input handling and determine whether attacker-controlled data reaches dangerous DOM sinks.
