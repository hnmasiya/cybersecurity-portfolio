# XSS Stored — DVWA Security Assessment

## Objective

Assess the DVWA XSS Stored vulnerability class in a controlled local laboratory environment and document the security implications, detection considerations and remediation strategy.
...
Test whether controlled script input is persistently stored and later rendered to application users.
