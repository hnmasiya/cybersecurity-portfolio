# Insecure CAPTCHA — DVWA Security Assessment

## Objective

Assess the DVWA Insecure CAPTCHA vulnerability class in a controlled local laboratory environment and document the security implications, detection considerations and remediation strategy.
...
Assess whether CAPTCHA controls can be bypassed or automated and whether authentication protections remain effective.
