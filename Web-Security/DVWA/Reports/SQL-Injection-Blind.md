# SQL Injection Blind — DVWA Security Assessment

## Objective

Assess the DVWA SQL Injection Blind vulnerability class in a controlled local laboratory environment and document the security implications, detection considerations and remediation strategy.
...
Test blind SQL injection conditions using controlled boolean or timing-based input and document observable differences.
